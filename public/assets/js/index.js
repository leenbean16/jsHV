...
//       changingroom: $("#changingroom").val(),
//       dancefloor: $("#dancefloor").val(),
//       decor: $("#decor").val(),
//       entertainment: $("#entertainment").val(),
//       firepit: $("#firepit").val(),
//       florist: $("#florist").val(),
//       hospitality: $("#hospitality").val(),
//       kitchen: $("#kitchen").val(),
//       masterofceremony: $("#masterofceremony").val(),
//       dj: $("#dj").val(),
//       liveband: $("#liveband").val(),
//       parking: $("#parking").val(),
//       photobooth: $("#photobooth").val(),
//       photographer: $("#photographer").val(),
//       pool: $("#pool").val(),
//       tablesandchairs: $("#tablesandchairs").val(),
//       created: Date.now()
//     }
//   })
